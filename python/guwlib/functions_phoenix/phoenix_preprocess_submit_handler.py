...
if __name__ == "__main__":
    ...
    skip_cae_just_solve = args[5] == "True"
    ...
    for model_file_path in model_file_paths:
        ...
        for job_file in enumerate(model_job_files):
            if i == 0:
