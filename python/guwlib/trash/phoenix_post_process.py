...
script, 'history_export_helper.py', to perform the extraction. The script processes each output
...
def extract_history_from_output_databases(results_folders):
    ...
    Note: ABAQUS software must be installed, and the helper script 'history_export_helper.py' is
    expected to be located in the 'guwlib/functions_odb/' directory.
    """

    helper_script_name = os.path.join('..', 'functions_odb', 'history_export_helper.py')
