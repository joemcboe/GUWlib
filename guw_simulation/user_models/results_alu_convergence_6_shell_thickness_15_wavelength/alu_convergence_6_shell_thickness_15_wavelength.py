...
# add defects ----------------------------------------------------------------------------------------------------------
defects = [Hole(position_x=0.23, position_y=0.16, diameter=10e-3)]

# add phased array -----------------------------------------------------------------------------------------------------
phased_array = []
pos_x = np.linspace(5e-2, 35e-2, 7)
...
fe_model.elements_in_thickness_direction = 6
fe_model.model_approach = 'point_force'
fe_model.element_type_temp = 'continuum_shell'
