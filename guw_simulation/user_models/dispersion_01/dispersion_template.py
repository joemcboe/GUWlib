...
# add phased array -----------------------------------------------------------------------------------------------------
phased_array = [PiezoElement(position_x=30e-3,
...
fe_model.nodes_per_wavelength = ##nodes_wavelength##
fe_model.elements_in_thickness_direction = ##elements_thickness##
fe_model.model_approach = 'point_force'
fe_model.element_type_temp = ##element_type##
fe_model.num_cores = 12
