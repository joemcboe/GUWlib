...
plate.add_hole(position=(0.15, 0.07), radius=3e-3, guideline_option='asterisk')
# plate.add_hole(position=(0.05, 0.14), radius=3e-3, guideline_option='plus')
# plate.add_hole(position=(0.10, 0.14), radius=3e-3, guideline_option='star')
# plate.add_hole(position=(0.15, 0.14), radius=3e-3, guideline_option='asterisk')
