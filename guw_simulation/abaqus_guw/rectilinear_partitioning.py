...
def partition_rectangular_plate(plate, bounding_box_list):
    ...
    :return:
    """
    cells, n_cells_x, n_cells_y = __generate_cell_array(plate.width, plate.height, bounding_box_list)
    area_total = plate.width * plate.height
